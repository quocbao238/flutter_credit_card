...
class CardBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (BuildContext context, BoxConstraints constraints) {
      final double screenWidth = constraints.maxWidth.isInfinite ? MediaQuery.of(context).size.width : constraints.maxWidth;
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: border,
              gradient: glassmorphismConfig != null ? glassmorphismConfig!.gradient : backgroundGradientColor,
            ...
            height: height ??
                (orientation == Orientation.portrait ? (((width ?? screenWidth) - (padding * 2)) * AppConstants.creditCardAspectRatio) : screenHeight / 2),
            child: ClipRRect(
          ...
          if (glassmorphismConfig != null)
            Padding(
              ...
              child: _GlassmorphicBorder(
                width: width ?? screenWidth,
                height: height ?? (orientation == Orientation.portrait ? ((screenWidth - 32) * 0.5714) : screenHeight / 2),
              ),
            ),
        ],
      );
...
class _GradientPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final LinearGradient gradient = LinearGradient(begin: Alignment.bottomRight, end: Alignment.topLeft, colors: <Color>[
    ...
    final RRect outerRect = RRect.fromRectAndRadius(Rect.fromLTRB(0, 0, size.width, size.height), Radius.circular(radius));
